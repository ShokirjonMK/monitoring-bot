...
# FILE_NAME = qabul_mysql_$(date +\%Y-\%m-\%d_\%H-\%M\-%S)
...
#docker compose -f /home/perfect/sites/tpu-qabul-yii/docker-compose.yml exec mysql mysqldump -uroot -pmkperfectQbull tpuqabuul > /home/perfect/mk_backup/qabul_mysql/FILE_NAME.sql
